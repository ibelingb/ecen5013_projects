...
#define LOG
    ...
    #define LOG_REMOTE_LOG_EVENT(event_e)
    #define LOG_REMOTE_STATUS_EVENT(event_e)
    #define LOG_REMOTE_DATA_EVENT(event_e)
    ...
    #define LOG_REMOTE_LOG_EVENT(event_e)      (LOG_THREAD_EVENT(event_e, LOG_MSG_REMOTE_LOG_EVENT))
    #define LOG_REMOTE_STATUS_EVENT(event_e)     (LOG_THREAD_EVENT(event_e, LOG_MSG_REMOTE_STATUS_EVENT))
    #define LOG_REMOTE_DATA_EVENT(event_e)     (LOG_THREAD_EVENT(event_e, LOG_MSG_REMOTE_DATA_EVENT))
