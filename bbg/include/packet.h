...
#define LOG_MSG_QUEUE_DEPTH         ((NUM_THREADS + NUM_REMOTE_REPORTING_THREADS) * 15) // total messages
...
typedef enum {
  ...
  MAIN_EVENT_SYSTEM_NOMINAL_STATE,
  MAIN_EVENT_SYSTEM_DEGRADED_STATE,
  MAIN_EVENT_SYSTEM_FAULT_STATE,
  MAIN_EVENT_CONTROLLOOP_IDLE_STATE,
  MAIN_EVENT_CONTROLLOOP_SCHEDPERIODIC_STATE,
  MAIN_EVENT_CONTROLLOOP_SCHEDONESHOT_STATE,
  MAIN_EVENT_CONTROLLOOP_WATERINGPLANT_STATE,
  MAIN_EVENT_END
} MainEvent_e;
